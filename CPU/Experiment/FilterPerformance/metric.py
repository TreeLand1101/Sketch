...
def plot_line_chart(data, metric, short_title, markers, line_styles, trace_label="", figsize=(10, 6)): 
    ...
    plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.2), ncol=4, fontsize=LABEL_SIZE) 
