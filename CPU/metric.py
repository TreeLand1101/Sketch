...
def plot_line_chart(data, metric, short_title, alpha, dataset, markers, line_styles, figsize=(12, 8), y_max=None):
...
def plot_bar_chart(data, metric, short_title, alpha, dataset, figsize=(12, 8), y_max=None):
    fig, ax = plt.subplots(figsize=figsize, constrained_layout=True)
